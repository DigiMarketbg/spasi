...
export const cardStyles = {
  ...
  button: "w-full mt-auto flex items-center gap-2 group bg-white text-green-600 border border-white hover:bg-green-700 hover:text-white dark:hover:bg-green-700 dark:hover:text-white transition-colors"
};
