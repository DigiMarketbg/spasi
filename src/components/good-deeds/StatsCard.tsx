...
const StatsCard = ({
  ...
  return <div className="flex items-center justify-center space-x-4 w-full max-w-md mx-auto">
      <Button onClick={onAdd} aria-label="Добави добро дело" className="w-10 h-10 rounded-lg bg-[#ea384c] hover:bg-[#c52c3f] text-white flex items-center justify-center">
