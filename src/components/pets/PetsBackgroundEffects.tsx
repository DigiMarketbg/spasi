  ...
  return (
    <div className="absolute inset-0 -z-10 overflow-hidden pointer-events-none select-none">
      ...
      <div 
        ...
        aria-hidden="true"
      >
        <Dog className="h-16 w-16 text-spasi-red" />
      </div>
      <div 
        ...
        aria-hidden="true"
      >
        <Cat className="h-14 w-14 text-secondary" />
      </div>
      <div 
      ...
      <div 
        className="absolute top-[10%] left-[5%] animate-float opacity-20 text-secondary font-bold select-none"
      ...
      <div 
        className="absolute top-[15%] right-[30%] animate-float opacity-20 text-spasi-red font-bold select-none"
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] opacity-10 pointer-events-none select-none">
        <div className="absolute inset-0 rounded-full border-2 border-spasi-red animate-ping" style={{ animationDuration: '3s' }} />
        <div className="absolute inset-0 rounded-full border-2 border-spasi-red animate-ping" style={{ animationDuration: '3s', animationDelay: '1s' }} />
        <div className="absolute inset-0 rounded-full border-2 border-spasi-red animate-ping" style={{ animationDuration: '3s', animationDelay: '2s' }} />
      </div>
    </div>
  );
};
